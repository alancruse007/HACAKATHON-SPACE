...
import p1 from '../assets/img/Planets/UNKNOWN/image.png'; // Importing image assets
import p2 from '../assets/img/Planets/UNKNOWN/image2.png';
import p3 from '../assets/img/Planets/UNKNOWN/image3.png';
import p4 from '../assets/img/Planets/UNKNOWN/image4.png';
import p5 from '../assets/img/Planets/UNKNOWN/image5.png';
...
const elements = [
    ...
    createExoplanet(
        p2,
        "TOI-1634 c",
        "TOI-1634 c is an unknown exoplanet that orbits an M-type star. Its mass is Unknown and it takes 103 days to complete one orbit of its star. Its discovery was announced in 2022.",
        'Unknown',
        'Unknown',
        'Radial Velocity',
        'Unknown',
    ...
    createExoplanet(
        p4,
        "KIC 10001893 b",
        "KIC 10001893 b is an unknown exoplanet that orbits a B-type star. Its mass is Unknown and it takes 0.2 days to complete one orbit of its star. Its discovery was announced in 2014.",
        'Unknown',
        'Unknown',
    ...
    createExoplanet(
        p5,
        "KIC 10001893 c",
        "KIC 10001893 c is an unknown exoplanet that orbits a B-type star. Its mass is Unknown and it takes 0.3 days to complete one orbit of its star. Its discovery was announced in 2014.",
        'Unknown',
        'Unknown',
        'Orbital Brightness Modulation',
        'Unknown',
