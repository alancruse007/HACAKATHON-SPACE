...
import p1 from '../assets/img/Planets/TERRESTRIAL/image .png'; // Importing image assets
import p2 from '../assets/img/Planets/TERRESTRIAL/image2.png';
import p3 from '../assets/img/Planets/TERRESTRIAL/image3.png';
import p4 from '../assets/img/Planets/TERRESTRIAL/image4.png';
import p5 from '../assets/img/Planets/TERRESTRIAL/image5.png';
...
const elements = [
    createExoplanet(
        p1,
        "GJ 238 b",
        "GJ 238 b is a terrestrial exoplanet that orbits a M-type star. Its mass is 0.126 Earths, it takes 1.7 days to complete one orbit of its star, and is 0.02123 AU from its star. Its discovery was announced in 2024.",
        '0.566 x Earth',
        '0.126 Earths',
        'Transit',
        '0.02123 AU',
    ...
    createExoplanet(
        p2,
        "TOI-4527.01",
        "TOI-4527.01 is a terrestrial exoplanet that orbits a M-type star. Its mass is 0.689 Earths, it takes 0.4 days to complete one orbit of its star, and is 0.008332 AU from its star. Its discovery was announced in 2024.",
        '0.909 x Earth',
        '0.689 Earths',
        'Transit',
        '0.008332 AU',
    ...
    createExoplanet(
        p3,
        "SPECULOOS-3 b",
        "SPECULOOS-3 b is a terrestrial exoplanet that orbits a M-type star. Its mass is 0.894 Earths, it takes 0.7 days to complete one orbit of its star, and is 0.00733 AU from its star. Its discovery was announced in 2024.",
        '0.977 x Earth',
        '0.894 Earths',
        'Transit',
        '0.00733 AU',
    ...
    createExoplanet(
        p4,
        "Teegarden’s Star d",
        "Teegarden's Star d is a terrestrial exoplanet that orbits an M-type star. Its mass is 0.82 Earths, it takes 26.1 days to complete one orbit of its star, and is 0.0791 AU from its star. Its discovery was announced in 2024.",
        '0.954 x Earth (estimate)',
        '0.82 Earths',
        'Radial Velocity',
        '0.0791 AU',
        '26.1 days'
